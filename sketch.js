...
function vundet() {
  ...
  if (f1 + f4 + f7 === 9 || f2 + f5 + f8 === 9 || f3 + f6 + f9 === 9) {
    gameOver = true;
    vinder = "kryds";
  }
  if (f1 + f5 + f9 === 9 || f7 + f5 + f3 === 9) {
    gameOver = true;
    vinder = "kryds";
  }
  // undersøg om O har vundet
  if (f1 + f2 + f3 === 15 || f4 + f5 + f6 === 15 || f7 + f8 + f9 === 15) {
    gameOver = true;
    vinder = "bolle";
  }
  if (f1 + f4 + f7 === 15 || f2 + f5 + f8 === 15 || f3 + f6 + f9 === 15) {
    gameOver = true;
    vinder = "bolle";
  }
  if (f1 + f5 + f9 === 15 || f7 + f5 + f3 === 15) {
    gameOver = true;
    vinder = "bolle";
